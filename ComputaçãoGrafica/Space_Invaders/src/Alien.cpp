...
//Construtor
Alien::Alien():pos_x(0),_life(true), pos_y(0),_speed(0.01),_lastUpdate(glutGet(GLUT_ELAPSED_TIME)){}

//Construtor
Alien::Alien(float xx, float yy):_life(true), pos_x(xx), pos_y(yy),_speed(0.01), _lastUpdate(glutGet(GLUT_ELAPSED_TIME)), _lastFire(0){}
