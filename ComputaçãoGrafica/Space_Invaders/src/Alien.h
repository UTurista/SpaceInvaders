...
#include "Material.h"
#endif
#pragma endregion Inclusao de Material.h Collider.h Vector Glut.h Bullet.h
...
public:
	Alien_1(): Alien(){};					
	Alien_1(float xx, float yy): Alien(xx,yy){};
...
public:
	Alien_2(): Alien(){};						
	Alien_2(float xx, float yy): Alien(xx,yy){};
...
public:
	Alien_3(): Alien(){};						
	Alien_3(float xx, float yy): Alien(xx,yy){};
